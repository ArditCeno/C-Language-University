...
int numeroTek(const int T[], int n){  //funksion qe numeron nr tek
	...
	for( int i=0; i<n; i++){          // bredhjen ne vektor
...
int main(){
	...
	for(int i=0; i<n; i++){              // bredhja ne vektor per te shtuar vlerat ne cdo indeks duke nisur nga index 0.1.2...
	...
	printf("Nr i elementeve tek", numeroTek(T, n));   //afishimi i shumes se nr tek
